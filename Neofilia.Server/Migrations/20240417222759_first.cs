    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Menus", x => new { x.MenuId, x.LocalId });
                    table.ForeignKey(
                        name: "FK_Menus_Locals_LocalId",
                        column: x => x.LocalId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rewards", x => new { x.RewardId, x.TableId });
                    table.ForeignKey(
                        name: "FK_Rewards_Tables_TableId",
                        column: x => x.TableId,
